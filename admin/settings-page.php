...
function rest_api_message()
{
    ?>
    <form class="rest-message-panel" method="post">
        <h2>Nice Message - Rest API</h2>
        <p>Retrieve a nice message from a custom Rest API!</p>
        <input type="submit" value="Restful" class="rest-message-button">
        <div class="rest-message-response"></div>
    </form>
    <?php
}
